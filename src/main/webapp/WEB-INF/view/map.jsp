        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="안심역" id="keyword" size="15">
...
<script>
    ...
    <c:forEach items="${latlng}" var="latlng">
    var mapContainer = document.getElementById('map'), // 지도를 표시할 div
        mapOption = {
            center: new kakao.maps.LatLng(${latlng.cntr_loc_lat}, ${latlng.cntr_loc_lng}), // 지도의 중심좌표
            level: 3 // 지도의 확대 레벨
        };
    </c:forEach>
...
<%--    <c:forEach items="${latlng}" var="latlng">--%>
<%--    var markerPosition  = new kakao.maps.LatLng(${latlng.cntr_loc_lat}, ${latlng.cntr_loc_lng});--%>
<%--    </c:forEach>--%>
